...
$gallery_cfg = array(
    'structure' => 'id:int,cid:page,title:string,alias:alias,pic_thumb:image,pic_full:image,pic_full_tit:text,preview:text,content:html,prop:prop,hot:int,hits:int,created:timestamp,modified:timestamp,published:timestamp',
    ...
    'task' => array(
        ...
        'edit' => array(
            'type' => 12,
            'auth' => 'access',
            'field' => 'title,alias,pic_thumb,pic_full,pic_full_tit,preview,content,prop,meta,published',
            'render' => 'title,alias,pic_thumb,pic_full,preview,content,prop,meta,published',
            'notnull' => 'title'
        ),
        'publish' => array(
            'type' => 21,
